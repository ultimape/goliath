...
Tweet IDs will be exported to a couple of files match the pattern `backup_export_[tweettype]_ids.txt`, and stored into whatever your console/terminal's current working dirctory is when you run the script.
