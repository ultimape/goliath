...
`backup_export_tweet_ids.txt` contains IDs of tweets you've personally tweeted out.  
`backup_export_retweet_ids.txt` contains IDs of tweet proxies associated with each of your retweets.  
`backup_export_retweeted_ids.txt` contains IDs of the actual retweeted tweets.  
`backup_export_quotetweet_ids.txt` contains IDs of any tweets you've linked to ('quoted') to in a tweet.  
`backup_export_replyto_ids.txt` contains IDs of a tweet that is listed as having been replied to.  
