...
One you have your twitter archive, extract/unzip it, and then you can run eatgrail.py as follows

`$ ./eatgrail/eatgrail.py -extract ./[$PATH_TO_ROOT_OF_ARCHIVE]`

replace `[$PATH_TO_ROOT_OF_ARCHIVE]` with the directory of your archive
